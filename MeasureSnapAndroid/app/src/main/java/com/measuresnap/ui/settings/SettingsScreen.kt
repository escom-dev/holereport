package com.measuresnap.ui.settings
    ...
    Column(
            ...
            Column(Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
                ...
                ExposedDropdownMenuBox(
                    ...
                    ExposedDropdownMenu(
                        ...
                        listOf("user", "admin", "cityadmin", "superadmin").forEach { type ->
                            DropdownMenuItem(
                                text = { Text(type) },
        ...
        Card {
            Column(Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(6.dp)) {
                ...
                Text("MeasureSnap Android", style = MaterialTheme.typography.bodyMedium)
